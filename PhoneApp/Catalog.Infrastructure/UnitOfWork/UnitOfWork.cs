...
{
    public class UnitOfWork<TContext> : InterfaceUnitOfWork, IDisposable where TContext : DbContext
    {
        #region Props
        ...
        public InterfaceRepository<TEntity> GetRepository<TEntity>() where TEntity : class
        {
